...
<% String password = request.getParameter("password"); %>
	...
	<% if(status.equals("false")){ %>
		<button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal"> Reserve Seat <%=index %> </button>
	<%}else{ %>
		<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal"> Login to seat <%=index %> </button>
	<%} %>
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <%--Registration process --%>
			...
			<form action="seat.jsp" style="margin-top:1em;" method="POST">
				...
				<input type="hidden" name="dateReg" value="<%=formatDate.format(date)%> <%=formatTime.format(date)%>">
                   ...
                   <br>
				<input type="submit" value="Reserve" class="btn btn-info" id="btnRegister">
			</form>
			<% } else{%>
	      <%--Login process with defined password on the specific locker --%>
			...
			<div class="modal fade" id="secondModal" style="margin-left:20em">
	      		...
	      		<div class="modal-header">
	        		...
	        		<center><input style="margin-bottom: 2em;" type="submit" class="btn btn-danger" value="Cancel"></center>
	        		<input type="hidden" name="status" value=<%=status %>>
	        		</form>
